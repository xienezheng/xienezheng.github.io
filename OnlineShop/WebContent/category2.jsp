...
<body>
	...
	<div id="page-content" class="single-page">
        ...
        经济款凉席<input type="checkbox" onclick="chose(this)" name="豪华床垫" value="20"/> 40￥    
             ...
             经济款脸盆<input type="checkbox" onclick="chose(this)" name="豪华脸盆" value="10"/> 20￥
								...
								<div class="col-lg-4 col-md-4 col-xs-12">
									<div class="product">
										...
										<div class="caption">
											 经济款三件套<input type="checkbox" name="豪华被子" value="30" onclick="chose(this)" />60￥   
        ...
        经济款床帘<input type="checkbox" onclick="chose(this)" name="豪华凉席" value="10"/>20￥    
