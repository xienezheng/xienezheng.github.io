...
<body>
	...
	<div id="page-content" class="single-page">
							...
							<div class="products">
								<div class="col-lg-4 col-md-4 col-xs-12">
									<div class="product">
										...
										<div class="caption">
											  基本款凉席<input type="checkbox" onclick="chose(this)" name="普通床垫" value="20"/> 20￥   
       ...
       基本款脸盆<input type="checkbox" onclick="chose(this)" name="普通脸盆" value="10"/> 10￥
								...
								<div class="col-lg-4 col-md-4 col-xs-12">
									<div class="product">
										...
										<div class="caption">
										 基本款三件套<input type="checkbox" name="普通被子" value="30" onclick="chose(this)" />30￥    
       ...
       基本款床帘<input type="checkbox" onclick="chose(this)" name="普通床帘" value="10"/> 10￥ 
											<div class="rating"><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star-empty"></span><span class="glyphicon glyphicon-star-empty"></span></div>
										</div>
									</div>
								</div>
