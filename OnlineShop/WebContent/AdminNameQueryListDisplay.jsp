...
user1=(ArrayList<ProductInfor>)session.getAttribute("namelist");

out.println("　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　姓名 　　　 商品名  　　　　　　　价格<br/>");
for(int i=0;i<user1.size();i++)
{
	out.println("　　　　　　　　　　　　　　　　　　　　　　　　　　　　　"+user1.get(i).getName()+"　　　"+user1.get(i).getProductname1()+"　　　　"+user1.get(i).getProductprice1()+"￥<br/>");
}
}catch(Exception e)
{
