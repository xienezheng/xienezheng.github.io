...
ArrayList<Suggestion> user1=new ArrayList<Suggestion>();



String sql="select * from suggestion";

user1=UserDao.QuerySuggestion(sql);
out.println("　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　姓名          建议<br/>");
for(int i=0;i<user1.size();i++)
{
	out.println("　　　　　　　　　　　　　　　　　　　　　　　　　　　　　"+user1.get(i).getName()+":"+user1.get(i).getSuggestion()+"<br/>");
}
}catch(Exception e)
{
