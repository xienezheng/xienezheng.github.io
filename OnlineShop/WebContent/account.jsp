		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<form name="form1" id="ff1" method="post" action="download">
				...
				<div class="col-md-6">
					<div class="heading"><h2>新用户请注册</h2></div>
					<form name="form2" id="ff2" method="post" action="guestloginup">
						<div class="form-group">
							<input type="text" class="form-control" placeholder="姓名" name="firstname" id="firstname" required>
						</div>
						
						<div class="form-group">
							<input type="tel" class="form-control" placeholder="宿舍地址 :" name="address" id="email" required>
						</div>
						<div class="form-group">
							<input type="tel" class="form-control" placeholder="电话 :" name="tel" id="phone" required>
						</div>
						<div class="form-group">
							<input name="gender" value='男' type="radio"> 男 <input name="gender" value='女' type="radio"> 女
						</div>
						<div class="form-group">
