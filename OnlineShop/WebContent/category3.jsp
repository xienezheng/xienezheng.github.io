	...
	<nav id="top">
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-6">
					<ul class="top-link">
						<li><a href="account.jsp"><span class="glyphicon glyphicon-user"></span> 用户中心</a></li>
	...
	<div id="page-content" class="single-page">
		<div class="container">
			<div class="row">
				...
				<form action="GetBetter.jsp" method="post">
			</div>
			<div class="row">
        ...
        豪华款凉席<input type="checkbox" onclick="chose(this)" name="豪华床垫" value="20"/> 60￥  
                ...
                豪华款脸盆<input type="checkbox" onclick="chose(this)" name="豪华脸盆" value="10"/> 30￥
								...
								<div class="col-lg-4 col-md-4 col-xs-12">
									<div class="product">
										...
										<div class="caption">
										 豪华款三级套<input type="checkbox" name="豪华被子" value="30" onclick="chose(this)" />90￥   
          ...
          <br/>  
          <br/>  
        豪华款床帘<input type="checkbox" onclick="chose(this)" name="豪华凉席" value="10"/>40￥    
					...
					<div class="widget wid-product">
						...
						<div class="content">
							...
							<div class="product">
								<a href="#"><img src="images/liangxi.jpg" /></a>
								<div class="wrapper">
									<h5><a href="#">内野凉席</a></h5>
									<div class="price">$122</div>
									<div class="rating"><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star-empty"></span></div>
